...
namespace DMAW_DND
{
    public class ImGuiController : IDisposable
    {
        ...
        public unsafe ImGuiController(int width, int height)
        {
            ...
            ImFontConfigPtr ptr2 = ImGuiNative.ImFontConfig_ImFontConfig();
            ImFontConfigPtr imFontConfigPtr = new ImFontConfigPtr(ptr2);
            imFontConfigPtr.OversampleH = 3;
            imFontConfigPtr.OversampleV = 3;
            imFontConfigPtr.PixelSnapH = true;
            io.Fonts.AddFontFromFileTTF("C:\\Windows\\Fonts\\TREBUC.ttf", 18f, imFontConfigPtr);
            io.Fonts.AddFontFromFileTTF("C:\\Windows\\Fonts\\TREBUC.ttf", 24f, imFontConfigPtr); //config.FontSizeRender
            io.Fonts.AddFontFromFileTTF("C:\\Windows\\Fonts\\TREBUC.ttf", 100f, imFontConfigPtr);
            io.Fonts.AddFontFromFileTTF("C:\\Windows\\Fonts\\TREBUC.ttf", 14f, imFontConfigPtr);
